...
def LSTM(input):
    ...
    ## linsvc and lstm motel both use this commented function. utils.py stores this common function now.
    ...
    #cleaned1 = clean_sentences(input['text'])
    cleaned1 = [utils.tokenize(x) for x in input['text']]
